...
V1.0
* Z порядок: наверх, вниз, на самый верх и в самый низ для объктов вытаженных из правой панели и вставленных из буфера обмена (группа кнопок до поворота страниц). Кнопки акттвны когда выделен объект.
* Сайт для проекта
...
V1.1
* Добавить Undo / Redo + соотв кнопки на заголовке окна (группа кнопок до Z-порядка). Кнопки акттвны когда есть наприавление в соответсвующей истории действий
...
V1.2
* Пернименование файла в заголовке с изменением его имени в Recent Open (только для Mac)
* Билд для windows
