...
abstract class AppLocalizations {
  ...
  /// No description provided for @errorReadingClipboard.
  ///
  /// In en, this message translates to:
  /// **'Failed to read from clipboard'**
  String get errorReadingClipboard;

  /// No description provided for @errorPasteFailed.
  ///
  /// In en, this message translates to:
  /// **'Failed to paste from clipboard'**
  String get errorPasteFailed;

  /// No description provided for @addingImage.
  ///
  /// In en, this message translates to:
  /// **'Adding image...'**
  String get addingImage;
  ...
  /// No description provided for @pasteImageMessage.
  ///
  /// In en, this message translates to:
  /// **'Where would you like to add this image?'**
  String get pasteImageMessage;
  ...
  /// No description provided for @noStamps.
  ///
  /// In en, this message translates to:
  /// **'No stamps yet. Add one to get started.'**
  String get noStamps;
  ...
  /// No description provided for @removeFromRecentConfirm.
  ///
  /// In en, this message translates to:
  ...
  /// No description provided for @noPdfOpen.
  ///
  /// In en, this message translates to:
  /// **'No PDF document open'**
  String get noPdfOpen;

  /// No description provided for @openPdfToStart.
  ///
  /// In en, this message translates to:
  /// **'Open a PDF to get started'**
  String get openPdfToStart;
