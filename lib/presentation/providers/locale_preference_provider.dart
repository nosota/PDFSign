...
const supportedLocales = <SupportedLocale>[
  ...
  SupportedLocale(code: 'zh_CN', nativeName: '简体中文', englishName: 'Chinese (Simplified)', locale: Locale('zh', 'CN')),
  SupportedLocale(code: 'zh_TW', nativeName: '繁體中文', englishName: 'Chinese (Traditional)', locale: Locale('zh', 'TW')),
